...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -641656871L;
    ...
    public final EnumPath<com.umc.spring.domain.enums.MemberMissionStatus> status = createEnum("status", com.umc.spring.domain.enums.MemberMissionStatus.class);
