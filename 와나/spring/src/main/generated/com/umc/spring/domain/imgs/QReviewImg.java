...
public class QReviewImg extends EntityPathBase<ReviewImg> {
    ...
    private static final long serialVersionUID = -719119322L;
    ...
    public final com.umc.spring.domain.QReview review;
    ...
    public QReviewImg(Class<? extends ReviewImg> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new com.umc.spring.domain.QReview(forProperty("review"), inits.get("review")) : null;
    }
