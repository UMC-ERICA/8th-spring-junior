...
public class QTerms extends EntityPathBase<Terms> {
    ...
    public final ListPath<umc.study.domain.mapping.MemberTerms, umc.study.domain.mapping.QMemberTerms> memberTermsList = this.<umc.study.domain.mapping.MemberTerms, umc.study.domain.mapping.QMemberTerms>createList("memberTermsList", umc.study.domain.mapping.MemberTerms.class, umc.study.domain.mapping.QMemberTerms.class, PathInits.DIRECT2);
